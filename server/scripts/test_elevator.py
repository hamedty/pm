...
async def main(system, ALL_NODES):
    ...
    a = input('type anything to home. or enter to dismiss')
    if a:
...
async def home_all_nodes(all_nodes, feeder, rail, robots, stations):
    ...
    await stations[0].set_valves([None, None, None, 1])
